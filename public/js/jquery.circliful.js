(function ($) {
    ...
    $.fn.circliful = function (options) {
        ...
        return this.each(function () {
            var customSettings = ["fgcolor", "bgcolor", "fill", "width", "dimension", "fontsize", "animationstep", "endPercent", "icon", "iconcolor", "iconsize", "border","begin"];
            ...
            var circ = Math.PI * 2;
            var quart = Math.PI / customSettingsObj.begin;
            var type = '';
